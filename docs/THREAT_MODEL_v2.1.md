...
| AD-4 | **Observator de rețea local** (ISP, Wi-Fi ostil, angajator) | Vede IP-ul utilizatorului și că vorbește cu Tor/bridge; volum și timing | Destinație, conținut, GHOST ca aplicație (cu bridges: nici Tor) |
