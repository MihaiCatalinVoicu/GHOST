...
| 23 | low | Testul de izolare era tautologic | **Rezolvat (runda 2); dovada live în jobul `live-tor`.** Conectorul relay-ului folosește aceeași funcție de conectare (`connect_isolated`) ca testul live, care compară circuitele reale a două scope-uri; testul unitar verifică alegerea token-ului |
