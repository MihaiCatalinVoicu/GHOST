...
-- (5) Invites this identity created (inviter side), with the two refresh times of a credit
-- sent to the drop, drawn at creation (§19.26).
CREATE TABLE ent_invite (
    ...
    late_refresh_minute INTEGER NOT NULL CHECK (late_refresh_minute % 60 = 0),
...
4. **Bookkeeping.** §19.24 point 8 and the open items of point 9 (d) are closed and Q31 is decided (§17). LIMITE L5 and L6 (E17, E30), INVARIANTS T2 and ADR-23 carry the change. The residues stay E1–E31; E17 gains the bit of point 1.
