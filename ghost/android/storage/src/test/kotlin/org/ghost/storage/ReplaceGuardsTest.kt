...
class ReplaceGuardsTest {
    ...
    fun invitesAreNeverReplaced(): Unit = EntitlementFixture().use { f ->
        ...
        val insert = "ent_invite(invite_index, state, payload, drop_namespace, listen_until_day) VALUES (?, 'created', ?, ?, ?)"
        for (i in 1..2) db.rejectsEveryInsert(msg, insert, i, bytes(538, 9), bytes(32, 9), DAY0 + 90)
