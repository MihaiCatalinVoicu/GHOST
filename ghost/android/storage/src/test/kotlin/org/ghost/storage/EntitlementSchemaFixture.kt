...
internal class EntitlementFixture : AutoCloseable {
    ...
    fun invite(i: Int) = db.exec(
        "INSERT INTO ent_invite(invite_index, state, payload, drop_namespace, listen_until_day, refresh_minute) VALUES (?, 'created', ?, ?, ?, ?)",
        listOf(i, bytes(538, i), bytes(32, i), DAY0 + 90, T0 + 100 * 86_400L),
    )
