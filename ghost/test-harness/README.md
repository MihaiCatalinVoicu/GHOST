...
| `privacy/` | Invarianții T1–T25 din threat model §9: schema observabilelor permise pentru relay, validatorul `capture-check`, fixture-uri pozitive/negative | activ din Faza 2 (T1 executabil); restul primesc implementări în fazele în care apar componentele |
