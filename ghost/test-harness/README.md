...
| `gates/t2-report/` | Rapoarte fixture pentru `scripts/gates/t2-report-check.sh` (raport complet de gate și de PR, raport cu o verificare lipsă sau picată, scară greșită, 23 respectiv 22 de mutanți detectați) | activ din Faza 8 (S10) |
